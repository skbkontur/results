...
namespace Kontur.Tests.Results.Conversion.Combinations.OrElse.ResultFailureResultPlain
{
    [TestFixture]
    internal class Method_Should
    {
        private static IEnumerable<(ResultFailure<int> Result1, Result<string> Result2, Result<string> Result)> CreateCases()
        {
            yield return (Result.Fail(1), Result<string>.Succeed(), Result<string>.Succeed());

            var fault = Result<string>.Fail("fault");
            yield return (Result.Fail(1), fault, fault);
        }

        private static readonly Func<ResultFailure<int>, Func<int, Result<string>>, ValueTask<Result<string>>>[] PassMethodsValueTasks =
        {
        ...
        private static readonly Func<ResultFailure<int>, Func<int, Result<string>>, Task<Result<string>>>[] PassMethodsTasks =
        {
        ...
        private static IEnumerable<Func<ResultFailure<int>, Func<int, Result<string>>, Task<Result<string>>>> PassMethods()
        {
        ...
        private static readonly Func<ResultFailure<int>, Func<Result<string>>, ValueTask<Result<string>>>[] FactoryMethodsValueTasks =
        {
            (result, factory) => ValueTaskFactory.Create(result).OrElse(factory),
        ...
        private static readonly Func<ResultFailure<int>, Func<Result<string>>, Task<Result<string>>>[] FactoryMethodsTasks =
        {
            (result, factory) => Task.FromResult(result).OrElse(factory),
        ...
        private static IEnumerable<Func<ResultFailure<int>, Func<Result<string>>, Task<Result<string>>>> FactoryMethods()
        {
        ...
        private static readonly Func<ResultFailure<int>, Result<string>, ValueTask<Result<string>>>[] PlainMethodsValueTasks =
        {
        ...
        private static readonly Func<ResultFailure<int>, Result<string>, Task<Result<string>>>[] PlainMethodsTasks =
        {
        ...
        private static IEnumerable<Func<ResultFailure<int>, Result<string>, Task<Result<string>>>> AllMethods()
        {
            yield return (result1, result2) => Task.FromResult(result1.OrElse(result2));
        ...
        public async Task Pass_Fault_If_Failure(Func<ResultFailure<int>, Func<int, Result<string>>, Task<Result<string>>> orElse)
        {
            ...
            var result = await orElse(
                source,
                fault => Result<string>.Fail(fault.ToString(CultureInfo.InvariantCulture))).ConfigureAwait(false);
