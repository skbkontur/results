...
namespace Kontur.Tests.Results.Conversion.Combinations.Linq.Result.TValue.SelectMany.Results2.Plain
{
    ...
    internal class Value_Should
    {
        ...
        public Result<string, int> Result_Result(Result<string, int> result1, Result<string, int> result2)
        {
            return
                from x in result1
                from y in result2
        ...
        [TestCaseSource(nameof(Cases))]
        public Result<string, int> Result_Let_Result(Result<string, int> result1, Result<string, int> result2)
        {
            return
        ...
        [TestCaseSource(nameof(Cases))]
        public Result<string, int> Result_Result_Let(Result<string, int> result1, Result<string, int> result2)
        {
            return
                from x in result1
        ...
        [TestCaseSource(nameof(Cases))]
        public Result<string, int> Result_Let_Result_Let(Result<string, int> result1, Result<string, int> result2)
        {
            return
                from xLet in result1
                let x = xLet
