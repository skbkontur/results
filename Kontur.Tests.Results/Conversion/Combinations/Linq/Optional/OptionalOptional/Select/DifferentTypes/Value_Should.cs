...
namespace Kontur.Tests.Results.Conversion.Combinations.Linq.Optional.OptionalOptional.Select.DifferentTypes
{
        ...
        where TFixtureCase : IFixtureCase, new()
    {
        ...
        private static Optional<string> SelectResult(int value)
        {
            return GetOption(ConvertToString(value));
        }

        [TestCaseSource(nameof(Cases))]
        public Optional<string> OneOption(Optional<int> optional)
        {
            return
        ...
        [TestCaseSource(nameof(Cases))]
        public Optional<string> Option_Let(Optional<int> optional)
        {
            return
